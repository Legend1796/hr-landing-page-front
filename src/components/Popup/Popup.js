    ...
    <div className={`popup ${isOpen && 'popup_opened'}`} >
      <div className='popup__container'>
        ...
        <div className='popup__background-container'>
          <a className='popup__link' href='https://t.me/practicum_experts' target='_blank' rel='noopener noreferrer'><img src={popupLink} className=' ' alt='ссылка на соцсети' /><p className='popup__button-name popup__button-name_color_white'>Поделиться</p></a>
